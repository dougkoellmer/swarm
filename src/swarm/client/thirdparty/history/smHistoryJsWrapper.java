...
public class smHistoryJsWrapper
{
	...
	public smHistoryJsWrapper(I_Listener listener)
	{
		m_listener = listener;
	...
	private static native void initialize(smHistoryJsWrapper thisArg)
	/*-{
			var History = $wnd.History;
		    ...
		    (
			    ...
			    function()
			    {
			        ...
			        thisArg.@swarm.client.thirdparty.history.smHistoryJsWrapper::onStateChange(Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(State.url, data);
			    }
			 );
	}-*/;
}
