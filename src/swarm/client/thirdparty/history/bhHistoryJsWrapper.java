	...
	/*-{
		    ...
		    (
			    ...
			    function()
			    {
			        ...
			        thisArg.@swarm.client.thirdparty.history.bhHistoryJsWrapper::onStateChange(Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(State.url, data);
			    }
			 );
	}-*/;
}
