...
import swarm.client.input.bhMouseEvent;
...
import swarm.client.ui.cell.bhVisualCell;
...
import swarm.shared.structs.bhVelocitySmoother;
	...
	public void onMouseEvent(bhMouseEvent event)
	{
		switch( event.getType())
		{
			...
			case MOUSE_DOWN:
			{
				...
				m_lastWorldPoint.copy(sm_c.camera.getPosition());
			...
			case MOUSE_UP:
			{
				...
				else if ( m_cameraState instanceof State_CameraFloating )
				{
					...
					if( !m_utilVector.isZeroLength(null) )
					{
						...
						m_utilPoint1.copy(sm_c.cameraMngr.getTargetPosition());
