...
{	
	...
	public State_CameraSnapping(AppContext appContext, double cellHudHeight)
	{
		...
		m_snapBufferManager = new CellBufferManager(m_appContext.gridMngr.getGrid(), m_appContext.codeMngr, m_appContext.cellSizeMngr, 1, appContext.config.maxKillQueueTime);
