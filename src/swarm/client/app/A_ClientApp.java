...
public class A_ClientApp extends A_App implements I_TimeSource
{
	...
	protected void stage_startAppManagers()
	{
		...
		m_appContext.cellBufferMngr = new CellBufferManager(m_appConfig.grid, m_appContext.codeMngr, m_appContext.cellSizeMngr, m_appConfig.metaLevelCount, m_appConfig.maxKillQueueTime);
