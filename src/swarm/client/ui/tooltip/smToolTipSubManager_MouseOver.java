...
class smToolTipSubManager_MouseOver implements smI_ToolTipSubManager, MouseOverHandler, MouseOutHandler, MouseMoveHandler, MouseDownHandler, MouseUpHandler, ClickHandler
{
	...
	private static final smPoint s_mousePoint = new smPoint();
	...
	private final Timer m_timer = new Timer()
	{
		...
		public void run()
		{
			...
			RootPanel.get().addDomHandler(smToolTipSubManager_MouseOver.this, MouseMoveEvent.getType());
		}
	};
