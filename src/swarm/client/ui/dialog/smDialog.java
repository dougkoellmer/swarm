...
public class smDialog extends AbsolutePanel
{
	...
	private final smDefaultButton m_okButton = new smDefaultButton();
	...
	public smDialog(int width, int height, I_Delegate delegate)
	{
		...
		sm_c.clickMngr.addClickHandler(m_okButton, new smI_ClickHandler()
		{
			@Override
			public void onClick()
			{
	...
	private native void scheduleLayoutUpdate(smDialog thisArg)
	/*-{
		setTimeout(function()
		{
