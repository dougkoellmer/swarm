...
import swarm.client.js.bhU_Native;
...
import swarm.client.ui.bhInitialSyncScreen;
...
import swarm.client.ui.widget.bhHtmlWrapper;
import swarm.client.ui.widget.bhI_TextBox;
import swarm.client.ui.widget.bhI_TextBoxChangeListener;
import swarm.client.ui.widget.bhPasswordTextBox;
import swarm.client.ui.widget.bhTextBox;
import swarm.client.ui.widget.bhTextBoxWrapper;
...
import swarm.shared.account.bhI_ValidationError;
...
public class bhSignUpPanel extends VerticalPanel implements bhI_StateEventListener
{
	...
	bhSignUpPanel()
	{
		...
		sm_c.toolTipMngr.addTip(m_button, new bhToolTipConfig(bhE_ToolTipType.MOUSE_OVER, "Do it now!"));
		...
		sm_c.clickMngr.addClickHandler(m_reloadCaptcha, new bhI_ClickHandler()
		{
			@Override
			public void onClick()
			{
		...
		sm_c.clickMngr.addClickHandler(m_button, new bhI_ClickHandler()
		{
			@Override
			public void onClick()
			{
	...
	private void submit(int focusedFieldIndex)
	{
		...
		if( canSubmit )
		{
			...
			String captchaResponse = sm_c.recaptchaWrapper.getResponse();
			String captchaChallenge = sm_c.recaptchaWrapper.getChallenge();
