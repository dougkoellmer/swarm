...
import swarm.shared.account.bhI_CredentialType;
...
public class bhSignInPanel extends VerticalPanel implements bhI_StateEventListener
{
	...
	bhSignInPanel()
	{
		...
		sm_c.toolTipMngr.addTip(m_button, new bhToolTipConfig(bhE_ToolTipType.MOUSE_OVER, "Do it!"));
		sm_c.toolTipMngr.addTip(m_changePassword, new bhToolTipConfig(bhE_ToolTipType.MOUSE_OVER,
		...
		sm_c.clickMngr.addClickHandler(m_changePassword, new bhI_ClickHandler()
		{
			@Override
			public void onClick()
			{
