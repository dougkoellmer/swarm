...
import swarm.client.ui.smInitialSyncScreen;
...
import swarm.client.ui.widget.smHtmlWrapper;
...
public class smSignUpPanel extends VerticalPanel implements smI_StateEventListener
{
	...
	smSignUpPanel()
	{
		...
		sm_c.toolTipMngr.addTip(m_button, new smToolTipConfig(smE_ToolTipType.MOUSE_OVER, "Do it now!"));
		...
		sm_c.clickMngr.addClickHandler(m_reloadCaptcha, new smI_ClickHandler()
		{
			@Override
			public void onClick()
			{
