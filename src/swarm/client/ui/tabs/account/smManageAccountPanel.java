...
public class smManageAccountPanel extends FlowPanel implements smI_StateEventListener
{
	...
	public smManageAccountPanel()
	{
		...
		sm_c.toolTipMngr.addTip(m_signOutButton, new smToolTipConfig(smE_ToolTipType.MOUSE_OVER, "Don't do it!"));
		
		sm_c.clickMngr.addClickHandler(m_signOutButton, new smI_ClickHandler()
		{
			@Override
			public void onClick()
			{
