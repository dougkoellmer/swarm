...
public class bhCodeEditorTabContent extends AbsolutePanel implements bhI_TabContent, bhI_CodeMirrorListener
{
	private static final Logger s_logger = Logger.getLogger(bhCodeEditorTabContent.class.getName());
