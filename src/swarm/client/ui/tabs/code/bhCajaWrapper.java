...
{	
	...
	/*-{
			...
			function onSuccess()
			{
				...
				(
					function()
					{
						@swarm.client.ui.tabs.code.bhCajaWrapper::tameApi(Ljava/lang/String;)(apiNamespace);
						thisArg.@swarm.client.ui.tabs.code.bhCajaWrapper::caja_initialize_success()();
					}
				);
			}
			...
			(
				...
				function() // on failure
				{
					thisArg.@swarm.client.ui.tabs.code.bhCajaWrapper::caja_initialize_failure()();
				}
			);
	}-*/;
	...
	/*-{
			function uriPolicyHelper(uri)
			{
				...
				var rewrittenUri = thisArg.@swarm.client.ui.tabs.code.bhCajaWrapper::rewriteUri(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)(fullUri, scheme, authority, attribute, path);
			...
			(
				...
				function(frame)
				{
					thisArg.@swarm.client.ui.tabs.code.bhCajaWrapper::onFrameLoad(Lcom/google/gwt/core/client/JavaScriptObject;)(frame);
	   				...
	   				if( listener != null )
	   				{
	   					listener.@swarm.client.ui.tabs.code.bhI_CodeLoadListener::onCodeLoad()();
	   				}
				},
				{
