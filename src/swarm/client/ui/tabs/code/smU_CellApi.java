...
import swarm.client.ui.cell.smAlertManager;
...
public class smU_CellApi
{
	...
	private static void snapToAddress(String rawAddress)
	{
		...
		smA_Action.perform(StateMachine_Camera.SnapToAddress.class, m_snapAddressArgs);
	}
	...
	private static void snapToCoordinate(double m, double n)
	{
		...
		smA_Action.perform(StateMachine_Camera.SnapToCoordinate.class, m_snapCoordArgs);
	}
