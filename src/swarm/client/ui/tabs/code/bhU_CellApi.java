...
import swarm.client.navigation.bhBrowserNavigator;
import swarm.client.states.camera.StateMachine_Camera;
import swarm.client.states.camera.State_ViewingCell;
import swarm.client.structs.bhAccountInfo;
import swarm.client.ui.cell.bhAlertManager;
...
public class bhU_CellApi
{
	...
	/*-{
		...
		function string_contract(string)
		{
			...
			@swarm.client.ui.tabs.code.bhU_CellApi::logError(Ljava/lang/String;)("Expected string value.");
			return false;
		}
		...
		$wnd[namespace] = 
		{
			snap:function()
			{
				...
				if( argumentsLength == 1 )
				{
					...
					{
						@swarm.client.ui.tabs.code.bhU_CellApi::snapToAddress(Ljava/lang/String;)(arguments[0]);
					}
					else if( isInt(arguments[0]) )
					{
						@swarm.client.ui.tabs.code.bhU_CellApi::snapToHistory(D)(arguments[0]);
					}
					else if( isCoordinate(arguments[0]) )
					{
						@swarm.client.ui.tabs.code.bhU_CellApi::snapToCoordinate(DD)(arguments[0].m, arguments[0].n);
					}
					else if( isPoint(arguments[0]) )
					{
						@swarm.client.ui.tabs.code.bhU_CellApi::snapToPoint(DDD)(arguments[0].x, arguments[0].y, arguments[0].z);
					}
				}
				else if( argumentsLength == 2 )
				{
					...
					{
						@swarm.client.ui.tabs.code.bhU_CellApi::snapToCoordinate(DD)(arguments[0], arguments[1]);
					}
					else if( isPoint.apply(null, args_modified) )
					{
						@swarm.client.ui.tabs.code.bhU_CellApi::snapToPoint(DDD)(arguments[0], arguments[1], 0.0);
					}
				}
				else if( argumentsLength == 3 )
				{
					...
					{
						@swarm.client.ui.tabs.code.bhU_CellApi::snapToPoint(DDD)(arguments[0], arguments[1], arguments[2]);
					}
				}
			},			
			getCoordinate:function()
			{
				...
				var m = @swarm.client.ui.tabs.code.bhU_CellApi::getCoordinateM()();
				var n = @swarm.client.ui.tabs.code.bhU_CellApi::getCoordinateN()();
			...
			getAddress:function()
			{
				var address = @swarm.client.ui.tabs.code.bhU_CellApi::getAddress()();
			...
			getPosition:function()
			{
				//--- DRK > Have to do it like this because of weird jsni behavior with
				//---		passing js objects across the interface.
				var x = @swarm.client.ui.tabs.code.bhU_CellApi::getPositionX()();
				var y = @swarm.client.ui.tabs.code.bhU_CellApi::getPositionY()();
				var z = @swarm.client.ui.tabs.code.bhU_CellApi::getPositionZ()();
			...
			{
				var username = @swarm.client.ui.tabs.code.bhU_CellApi::getUsername()();
				
				return username;
			},
			getGridWidth:function()
			{
				var width = @swarm.client.ui.tabs.code.bhU_CellApi::getGridWidth()();
				
				return width;
			},
			getGridHeight:function()
			{
				var height = @swarm.client.ui.tabs.code.bhU_CellApi::getGridHeight()();
		...
		$wnd[namespace+"_alert"] = function(message)
		{
			...
			{
				@swarm.client.ui.tabs.code.bhU_CellApi::alert(Ljava/lang/String;)(message);
			}
		}
	...
	{
		sm_c.navigator.getBrowserNavigator().go((int)delta);
	}
