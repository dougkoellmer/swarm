...
import swarm.client.ui.widget.bhSpriteButton;
...
public class bhVisualCellHud extends FlowPanel implements bhI_UIElement
{
	...
	public bhVisualCellHud(Panel parent, bhClientAppConfig appConfig)
	{
		...
		sm_c.clickMngr.addClickHandler(m_refresh, new bhI_ClickHandler()
		{
			@Override
			public void onClick()
			{
		...
		sm_c.clickMngr.addClickHandler(m_close, new bhI_ClickHandler()
		{
			@Override
			public void onClick()
			{
