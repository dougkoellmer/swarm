...
import swarm.client.app.bhS_Client;
...
import swarm.client.structs.bhI_CellPoolDelegate;
import swarm.client.ui.bhI_UIElement;
import swarm.client.ui.bhU_UI;
import swarm.client.ui.cell.bhAlertManager.I_Delegate;
import swarm.client.ui.dialog.bhDialog;
import swarm.shared.app.bhS_App;
import swarm.shared.debugging.bhU_Debug;
import swarm.shared.entities.bhA_Grid;
import swarm.shared.entities.bhU_Grid;
...
public class bhVisualCellManager implements bhI_UIElement, bhI_CellPoolDelegate
{
	...
	private boolean updateCellTransforms(double timeStep)
	{
		...
		bhA_Grid grid = sm_c.gridMngr.getGrid(); // TODO: Get grid from somewhere else.
