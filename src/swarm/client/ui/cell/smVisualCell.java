...
import swarm.client.ui.tabs.code.smI_CodeLoadListener;
import swarm.client.ui.widget.smUIBlocker;
...
public class smVisualCell extends AbsolutePanel implements smI_BufferCellListener
{
	...
	public void onFocusGained()
	{
		...
		sm_c.cellSandbox.allowScrolling(m_contentPanel.getElement(), true);
	}
	...
	public void onFocusLost()
	{
		...
		if( sm_c.cellSandbox.isRunning() )
		{
			sm_c.cellSandbox.stop();
		}
		
		sm_c.cellSandbox.allowScrolling(m_contentPanel.getElement(), false);
	}
	...
	public void setCode(smCode code, String idClass)
	{
		...
		else if( code.getSafetyLevel() == smE_CodeSafetyLevel.REQUIRES_STATIC_SANDBOX )
		{
			...
			sm_c.cellSandbox.insertStaticHtml(m_contentPanel.getElement(), code.getRawCode(), idClass);
		}
		else if( code.getSafetyLevel() == smE_CodeSafetyLevel.REQUIRES_DYNAMIC_SANDBOX )
		{
			...
			sm_c.cellSandbox.start(m_contentPanel.getElement(), code.getRawCode(), null, idClass, m_codeLoadListener);
		}
	}
