...
public class bhCellSpinner extends FlowPanel
{
	private static final double WING_FLAP_TIME = 1.0/30.0;
	
	private static final Logger s_logger = Logger.getLogger(bhCellSpinner.class.getName());
	...
	public bhCellSpinner(double rotationRate)
	{
