...
public class BaseCheckBox extends FlowPanel
{
	...
	public BaseCheckBox(ClickManager clickMngr, String text)
	{
		...
		clickMngr.addClickHandler(m_clickCatcher, new I_ClickHandler()
		{
			@Override
