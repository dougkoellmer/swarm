...
public class CodeMirrorWrapper extends Widget
{
	private static final Logger s_logger = Logger.getLogger(CodeMirrorWrapper.class.getName());
	
	private String m_id = null;
	private Element m_hostElement;
	
	private I_CodeMirrorListener m_listener = null;
	...
	public CodeMirrorWrapper(I_CodeMirrorListener listener, boolean readOnly)
	{
		super();
	...
	/*-{
		...
		{
			self.@swarm.client.view.tabs.code.CodeMirrorWrapper::onChange()();
		}
		
		var onSave = function()
		{
			self.@swarm.client.view.tabs.code.CodeMirrorWrapper::onSave()();
		}
		
		var onPreview = function()
		{
			self.@swarm.client.view.tabs.code.CodeMirrorWrapper::onPreview()();
		}
		...
		var hostElement = this.@swarm.client.view.tabs.code.CodeMirrorWrapper::m_hostElement;
	...
	/*-{
			var codeMirror = this.@swarm.client.view.tabs.code.CodeMirrorWrapper::m_codeMirror;
