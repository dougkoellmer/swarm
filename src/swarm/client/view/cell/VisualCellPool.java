...
//					cell.removeFromParent();
		...
		@Override public void onCodeLoaded(VisualCell cell)
		{
			...
			if( state instanceof I_State_SnappingOrViewing )
			{
				...
				if( snappingOrViewing.getTargetCoord().equals(bufferCell.getCoordinate()) )
				{
					...
					{
						m_viewContext.stateContext.perform(StateMachine_Camera.OnCellWithNaturalDimensionsLoaded.class);
					}
				}
			}
		}
	...
	@Override public I_CellVisualization createVisualization(BufferCell bufferCell, int width, int height, int padding, int subCellDim, int highestPossibleSubCellCount, boolean justRemovedMetaCountOverride)
	{
...
//		newVisualCell.setVisible(true);
	...
	@Override public void destroyVisualization(I_CellVisualization visualization)
	{
