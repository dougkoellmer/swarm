...
public class smSpritePlateSpinner extends FlowPanel implements smI_CellSpinner
{
	...
	public smSpritePlateSpinner(String className, int frameCount, double frameRate)
	{
