...
public class Dialog extends AbsolutePanel
{
	...
	private final DefaultButton m_okButton = new DefaultButton();
	...
	public Dialog(ClickManager clickMngr, int width, int height, I_Delegate delegate)
	{
		m_delegate = delegate;
		...
		clickMngr.addClickHandler(m_okButton, new I_ClickHandler()
		{
			@Override
	...
	private native void scheduleLayoutUpdate(Dialog thisArg)
	/*-{
		setTimeout(function()
		{
			thisArg.@swarm.client.view.dialog.Dialog::updateLayout()();
		}, 0);
	}-*/;
