...
{
	private final Point m_touchPoint = new Point();
	
	public ClickManager()
	{
	}
	
	public void addClickHandler(Widget widget, final I_ClickHandler handler)
	{
	...
	private native void register(I_ClickHandler clickHandler, Element element)
	/*-{
		...
		function handler(event)
		{
			...
			clickHandler.@swarm.client.input.I_ClickHandler::onClick(II)(relativeX, relativeY);
		}
