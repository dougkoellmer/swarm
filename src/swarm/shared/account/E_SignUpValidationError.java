...
public enum E_SignUpValidationError implements I_ValidationError
{
	NO_ERROR,
	...
	private E_SignUpValidationError()
	{
	}
	 ...
	 */
	@Override
	public String calcErrorText(I_CredentialType credential)
	{
		switch(this)
		{
			case NO_ERROR:
			{
				return credential != E_SignUpCredentialType.CAPTCHA_RESPONSE ? "Good" : "Good (maybe)";
			}
