...
import swarm.shared.debugging.bhU_Logging;
...
public abstract class bhA_Coordinate extends bhA_JsonEncodable
{
	...
	public void writeJson(bhI_JsonObject json)
	{
		...
		sm.jsonFactory.getHelper().putJsonArray(json, bhE_JsonKey.pointComponents, components);
	}
	
	@Override
	public void readJson(bhI_JsonObject json)
	{
		bhI_JsonArray components = sm.jsonFactory.getHelper().getJsonArray(json, bhE_JsonKey.pointComponents);
		if( components != null )
		{
	...
	{
		return sm.jsonFactory.getHelper().containsAllKeys(json, bhE_JsonKey.pointComponents);
	}
