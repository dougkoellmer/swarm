...
public class bhGetCellAddressMappingResult extends bhA_JsonEncodable
{
	...
	public void writeJson(bhI_JsonObject json)
	{
		...
		sm.jsonFactory.getHelper().putEnum(json, bhE_JsonKey.getCellAddressMappingError, m_error);
	}

	@Override
	public void readJson(bhI_JsonObject json)
	{
		m_error = sm.jsonFactory.getHelper().getEnum(json, bhE_JsonKey.getCellAddressMappingError, bhE_GetCellAddressMappingError.values());
