...
public class bhGetCellAddressResult extends bhA_JsonEncodable
{
	...
	public void writeJson(bhI_JsonObject json)
	{
		...
		sm.jsonFactory.getHelper().putEnum(json, bhE_JsonKey.getCellAddressError, m_error);
	}

	@Override
	public void readJson(bhI_JsonObject json)
	{
		m_error = sm.jsonFactory.getHelper().getEnum(json, bhE_JsonKey.getCellAddressError, bhE_GetCellAddressError.values());
