...
public class bhFileRange extends bhA_JsonEncodable
{
	...
	{
		sm.jsonFactory.getHelper().putJavaVarArgs(json, bhE_JsonKey.fileRange, (Object[])m_range);
	}
	...
	{
		m_range = new Integer[4];
		bhI_JsonArray range = sm.jsonFactory.getHelper().getJsonArray(json, bhE_JsonKey.fileRange);
