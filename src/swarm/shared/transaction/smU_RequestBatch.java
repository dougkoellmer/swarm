...
public class smU_RequestBatch
{
	...
	{
		return sm.jsonFactory.getHelper().getJsonArray(json, smE_JsonKey.requestList) != null;
	}
	
	public static int getBatchSize(smI_JsonObject json)
	{
		return sm.jsonFactory.getHelper().getJsonArray(json, smE_JsonKey.requestList).getSize();
	}
	
	public static void readRequestList(smI_JsonObject json, I_JsonReadDelegate delegate)
	{
		smI_JsonArray requestList = sm.jsonFactory.getHelper().getJsonArray(json, smE_JsonKey.requestList);
