...
public class bhTransactionResponse extends bhA_TransactionObject
{
	...
	public void writeJson(bhI_JsonObject json)
	{
		...
		sm.jsonFactory.getHelper().putEnum(json, bhE_JsonKey.responseError, m_error);
	}
	
	@Override
	public void readJson(bhI_JsonObject json)
	{
		m_error = sm.jsonFactory.getHelper().getEnum(json, bhE_JsonKey.responseError, bhE_ResponseError.values());
