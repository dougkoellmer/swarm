...
public abstract class A_ServerApp extends A_App
{
	...
	protected A_ServerApp(ServerContext serverContext)
	{
	...
	protected void entryPoint(ServerAppConfig appConfig)
	{
		...
		m_context.txnMngr = new ServerTransactionManager((A_ServerJsonFactory) m_context.jsonFactory, m_context.requestPathMngr, appConfig.verboseTransactions, appConfig.libVersion, appConfig.appVersion);
