...
public class SpecialHtmlSchema extends HtmlSchema
{
	private static final Logger s_logger = Logger.getLogger(SpecialHtmlSchema.class.getName());
	...
	public SpecialHtmlSchema(HtmlSchema inner)
	{
