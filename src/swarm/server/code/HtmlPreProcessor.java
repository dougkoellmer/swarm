...
{
	private static final Logger s_logger = Logger.getLogger(HtmlPreProcessor.class.getName());
	
	private boolean m_foundJs = false;
	private final SpecialHtmlSchema m_schema;
	...
	public HtmlPreProcessor(Dom htmlDom, SpecialHtmlSchema schema)
	{
		m_dom = htmlDom;
