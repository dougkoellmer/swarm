...
public class smHtmlSchema extends HtmlSchema
{
	private static final Logger s_logger = Logger.getLogger(smHtmlSchema.class.getName());
	...
	public smHtmlSchema(HtmlSchema inner)
	{
