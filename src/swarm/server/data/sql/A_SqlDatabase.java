...
public class A_SqlDatabase implements I_TransactionScopeListener
{
	private final static Logger s_logger = Logger.getLogger(A_SqlDatabase.class.getName());
	...
	protected A_SqlDatabase(String databaseUrl, String databaseName)
	{
