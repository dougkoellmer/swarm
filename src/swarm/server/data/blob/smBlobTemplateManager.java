...
{	
	...
	private synchronized smI_Blob registerTemplate(Class<? extends smI_Blob> T) throws bhBlobException
	{
		...
		smI_Blob template = bhU_Blob.createBlobInstance(T);
	...
	smI_Blob getTemplate(Class<? extends smI_Blob> T) throws bhBlobException
	{
