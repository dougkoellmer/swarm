 ...
 * @author 
 */
public class bhClientUser extends bhA_User implements bhI_LocalCodeRepository
{
	...
	private static final bhClientUser s_instance = new bhClientUser();
	...
	private final bhUserCell m_sandboxCell;
	
	private bhClientUser()
	{
		m_sandboxCell = new bhUserCell(new bhGridCoordinate(bhS_App.SANDBOX_COORD_M, bhS_App.SANDBOX_COORD_N));
	}
	
	public static bhClientUser getInstance()
	{
		return s_instance;
	}
	...
	private bhUserCell getCellLenient(bhGridCoordinate coord)
	{
		if( coord.isEqualTo(m_sandboxCell.getCoordinate()) )
		{
			return m_sandboxCell;
		}
